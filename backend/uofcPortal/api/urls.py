...
from .views import UserViewSet, StudentViewSet, FacultyViewSet, DepartmentViewSet, ProgramViewSet, CourseViewSet, InstructorViewSet, LectureViewSet, GradeViewSet
