<template>
  <div class="flex flex-col w-screen" :class="{'pl-96': navbarVisible}">
    <AppNavbar v-if="navbarVisible" :selected="selected" />
    <div class="w-full">
      <div class="flex items-center justify-start py-4 px-4">
        <div class="flex items-center space-x-2 bg-white shadow-md rounded-lg p-2 w-full max-w-96">
          ...
          <button v-if="navbarVisible" class="bg-transparent p-2 rounded-full text-gray-500 hover:text-gray-700 focus:outline-none" @click="showSearchResults">
