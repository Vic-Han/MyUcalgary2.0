          ...
          <div class="bg-white-100 px-5 pt-5 pb-7 rounded-xl shadow-lg"> 
            <div class="relative flex justify-end mr-4 mb-8">
                ...
                <div class="grid grid-cols-5">
                  <div class=" text-center rounded-tl-xl px-4 py-4 bg-grey-100 border border-gray-300 cursor-pointer" v-bind:class="{'bg-white-100 border-b-0' : activeTab =='all'}" @click="activeTab = 'all' ">All</div>
                  <div class=" text-center px-4 py-4 bg-grey-100 border border-gray-300 cursor-pointer" v-bind:class="{'bg-white-100 border-b-0' : activeTab =='fee'}" @click="activeTab = 'fee' ">Fees</div>
                  <div class=" text-center px-4 py-4 bg-grey-100 border border-gray-300 cursor-pointer" v-bind:class="{'bg-white-100 border-b-0' : activeTab =='payment'}" @click="activeTab = 'payment'">Payments</div>
                  <div class=" text-center px-4 py-4 bg-grey-100 border border-gray-300 cursor-pointer" v-bind:class="{'bg-white-100 border-b-0' : activeTab =='scholarship'}" @click=" activeTab = 'scholarship'">Scholarships</div>
                  <div class=" text-center rounded-tr-xl px-4 pt-4 pb-4 bg-grey-100 border border-gray-300 cursor-pointer" v-bind:class="{'bg-white-100 border-b-0' : activeTab =='award'}" @click="activeTab = 'award'">Awards</div>
                </div>
